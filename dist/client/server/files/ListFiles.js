...
function ListFiles(request, serverID, directory) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield request(`/servers/${serverID}/files/list${directory ? `?directory=${encodeURIComponent(directory)}` : ""}`, {
                method: "GET"
            });
