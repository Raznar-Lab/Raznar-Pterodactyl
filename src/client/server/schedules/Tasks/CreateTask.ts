...
export default async function CreateTask(request: IRequest, serverID: string, scheduleID: number, scheduleTask: IClientServerScheduleTaskArgs): Promise<IClientServerScheduleTask> {
    try {
